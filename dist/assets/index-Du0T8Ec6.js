...
*/var fr,sw;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function I(){}I.prototype=y.prototype,T.D=y.prototype,T.prototype=new I,T.prototype.constructor=T,T.C=function(S,C,b){for(var k=Array(arguments.length-2),Rt=2;Rt<arguments.length;Rt++)k[Rt-2]=arguments[Rt];return y.prototype[C].apply(S,k)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,y,I){I||(I=0);var S=Array(16);if(typeof y=="string")for(var C=0;16>C;++C)S[C]=y.charCodeAt(I++)|y.charCodeAt(I++)<<8|y.charCodeAt(I++)<<16|y.charCodeAt(I++)<<24;else for(C=0;16>C;++C)S[C]=y[I++]|y[I++]<<8|y[I++]<<16|y[I++]<<24;y=T.g[0],I=T.g[1],C=T.g[2];var b=T.g[3],k=y+(b^I&(C^b))+S[0]+3614090360&4294967295;y=I+(k<<7&4294967295|k>>>25),k=b+(C^y&(I^C))+S[1]+3905402710&4294967295,b=y+(k<<12&4294967295|k>>>20),k=C+(I^b&(y^I))+S[2]+606105819&4294967295,C=b+(k<<17&4294967295|k>>>15),k=I+(y^C&(b^y))+S[3]+3250441966&4294967295,I=C+(k<<22&4294967295|k>>>10),k=y+(b^I&(C^b))+S[4]+4118548399&4294967295,y=I+(k<<7&4294967295|k>>>25),k=b+(C^y&(I^C))+S[5]+1200080426&4294967295,b=y+(k<<12&4294967295|k>>>20),k=C+(I^b&(y^I))+S[6]+2821735955&4294967295,C=b+(k<<17&4294967295|k>>>15),k=I+(y^C&(b^y))+S[7]+4249261313&4294967295,I=C+(k<<22&4294967295|k>>>10),k=y+(b^I&(C^b))+S[8]+1770035416&4294967295,y=I+(k<<7&4294967295|k>>>25),k=b+(C^y&(I^C))+S[9]+2336552879&4294967295,b=y+(k<<12&4294967295|k>>>20),k=C+(I^b&(y^I))+S[10]+4294925233&4294967295,C=b+(k<<17&4294967295|k>>>15),k=I+(y^C&(b^y))+S[11]+2304563134&4294967295,I=C+(k<<22&4294967295|k>>>10),k=y+(b^I&(C^b))+S[12]+1804603682&4294967295,y=I+(k<<7&4294967295|k>>>25),k=b+(C^y&(I^C))+S[13]+4254626195&4294967295,b=y+(k<<12&4294967295|k>>>20),k=C+(I^b&(y^I))+S[14]+2792965006&4294967295,C=b+(k<<17&4294967295|k>>>15),k=I+(y^C&(b^y))+S[15]+1236535329&4294967295,I=C+(k<<22&4294967295|k>>>10),k=y+(C^b&(I^C))+S[1]+4129170786&4294967295,y=I+(k<<5&4294967295|k>>>27),k=b+(I^C&(y^I))+S[6]+3225465664&4294967295,b=y+(k<<9&4294967295|k>>>23),k=C+(y^I&(b^y))+S[11]+643717713&4294967295,C=b+(k<<14&4294967295|k>>>18),k=I+(b^y&(C^b))+S[0]+3921069994&4294967295,I=C+(k<<20&4294967295|k>>>12),k=y+(C^b&(I^C))+S[5]+3593408605&4294967295,y=I+(k<<5&4294967295|k>>>27),k=b+(I^C&(y^I))+S[10]+38016083&4294967295,b=y+(k<<9&4294967295|k>>>23),k=C+(y^I&(b^y))+S[15]+3634488961&4294967295,C=b+(k<<14&4294967295|k>>>18),k=I+(b^y&(C^b))+S[4]+3889429448&4294967295,I=C+(k<<20&4294967295|k>>>12),k=y+(C^b&(I^C))+S[9]+568446438&4294967295,y=I+(k<<5&4294967295|k>>>27),k=b+(I^C&(y^I))+S[14]+3275163606&4294967295,b=y+(k<<9&4294967295|k>>>23),k=C+(y^I&(b^y))+S[3]+4107603335&4294967295,C=b+(k<<14&4294967295|k>>>18),k=I+(b^y&(C^b))+S[8]+1163531501&4294967295,I=C+(k<<20&4294967295|k>>>12),k=y+(C^b&(I^C))+S[13]+2850285829&4294967295,y=I+(k<<5&4294967295|k>>>27),k=b+(I^C&(y^I))+S[2]+4243563512&4294967295,b=y+(k<<9&4294967295|k>>>23),k=C+(y^I&(b^y))+S[7]+1735328473&4294967295,C=b+(k<<14&4294967295|k>>>18),k=I+(b^y&(C^b))+S[12]+2368359562&4294967295,I=C+(k<<20&4294967295|k>>>12),k=y+(I^C^b)+S[5]+4294588738&4294967295,y=I+(k<<4&4294967295|k>>>28),k=b+(y^I^C)+S[8]+2272392833&4294967295,b=y+(k<<11&4294967295|k>>>21),k=C+(b^y^I)+S[11]+1839030562&4294967295,C=b+(k<<16&4294967295|k>>>16),k=I+(C^b^y)+S[14]+4259657740&4294967295,I=C+(k<<23&4294967295|k>>>9),k=y+(I^C^b)+S[1]+2763975236&4294967295,y=I+(k<<4&4294967295|k>>>28),k=b+(y^I^C)+S[4]+1272893353&4294967295,b=y+(k<<11&4294967295|k>>>21),k=C+(b^y^I)+S[7]+4139469664&4294967295,C=b+(k<<16&4294967295|k>>>16),k=I+(C^b^y)+S[10]+3200236656&4294967295,I=C+(k<<23&4294967295|k>>>9),k=y+(I^C^b)+S[13]+681279174&4294967295,y=I+(k<<4&4294967295|k>>>28),k=b+(y^I^C)+S[0]+3936430074&4294967295,b=y+(k<<11&4294967295|k>>>21),k=C+(b^y^I)+S[3]+3572445317&4294967295,C=b+(k<<16&4294967295|k>>>16),k=I+(C^b^y)+S[6]+76029189&4294967295,I=C+(k<<23&4294967295|k>>>9),k=y+(I^C^b)+S[9]+3654602809&4294967295,y=I+(k<<4&4294967295|k>>>28),k=b+(y^I^C)+S[12]+3873151461&4294967295,b=y+(k<<11&4294967295|k>>>21),k=C+(b^y^I)+S[15]+530742520&4294967295,C=b+(k<<16&4294967295|k>>>16),k=I+(C^b^y)+S[2]+3299628645&4294967295,I=C+(k<<23&4294967295|k>>>9),k=y+(C^(I|~b))+S[0]+4096336452&4294967295,y=I+(k<<6&4294967295|k>>>26),k=b+(I^(y|~C))+S[7]+1126891415&4294967295,b=y+(k<<10&4294967295|k>>>22),k=C+(y^(b|~I))+S[14]+2878612391&4294967295,C=b+(k<<15&4294967295|k>>>17),k=I+(b^(C|~y))+S[5]+4237533241&4294967295,I=C+(k<<21&4294967295|k>>>11),k=y+(C^(I|~b))+S[12]+1700485571&4294967295,y=I+(k<<6&4294967295|k>>>26),k=b+(I^(y|~C))+S[3]+2399980690&4294967295,b=y+(k<<10&4294967295|k>>>22),k=C+(y^(b|~I))+S[10]+4293915773&4294967295,C=b+(k<<15&4294967295|k>>>17),k=I+(b^(C|~y))+S[1]+2240044497&4294967295,I=C+(k<<21&4294967295|k>>>11),k=y+(C^(I|~b))+S[8]+1873313359&4294967295,y=I+(k<<6&4294967295|k>>>26),k=b+(I^(y|~C))+S[15]+4264355552&4294967295,b=y+(k<<10&4294967295|k>>>22),k=C+(y^(b|~I))+S[6]+2734768916&4294967295,C=b+(k<<15&4294967295|k>>>17),k=I+(b^(C|~y))+S[13]+1309151649&4294967295,I=C+(k<<21&4294967295|k>>>11),k=y+(C^(I|~b))+S[4]+4149444226&4294967295,y=I+(k<<6&4294967295|k>>>26),k=b+(I^(y|~C))+S[11]+3174756917&4294967295,b=y+(k<<10&4294967295|k>>>22),k=C+(y^(b|~I))+S[2]+718787259&4294967295,C=b+(k<<15&4294967295|k>>>17),k=I+(b^(C|~y))+S[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(C+(k<<21&4294967295|k>>>11))&4294967295,T.g[2]=T.g[2]+C&4294967295,T.g[3]=T.g[3]+b&4294967295}r.prototype.u=function(T,y){y===void 0&&(y=T.length);for(var I=y-this.blockSize,S=this.B,C=this.h,b=0;b<y;){if(C==0)for(;b<=I;)i(this,T,b),b+=this.blockSize;if(typeof T=="string"){for(;b<y;)if(S[C++]=T.charCodeAt(b++),C==this.blockSize){i(this,S),C=0;break}}else for(;b<y;)if(S[C++]=T[b++],C==this.blockSize){i(this,S),C=0;break}}this.h=C,this.o+=y},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;var I=8*this.o;for(y=T.length-8;y<T.length;++y)T[y]=I&255,I/=256;for(this.u(T),T=Array(16),y=I=0;4>y;++y)for(var S=0;32>S;S+=8)T[I++]=this.g[y]>>>S&255;return T};function s(T,y){var I=l;return Object.prototype.hasOwnProperty.call(I,T)?I[T]:I[T]=y(T)}function o(T,y){this.h=y;for(var I=[],S=!0,C=T.length-1;0<=C;C--){var b=T[C]|0;S&&b==y||(I[C]=b,S=!1)}this.g=I}var l={};function u(T){return-128<=T&&128>T?s(T,function(y){return new o([y|0],0>y?-1:0)}):new o([T|0],0>T?-1:0)}function c(T){if(isNaN(T)||!isFinite(T))return p;if(0>T)return P(c(-T));for(var y=[],I=1,S=0;T>=I;S++)y[S]=T/I|0,I*=4294967296;return new o(y,0)}function f(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return P(f(T.substring(1),y));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var I=c(Math.pow(y,8)),S=p,C=0;C<T.length;C+=8){var b=Math.min(8,T.length-C),k=parseInt(T.substring(C,C+b),y);8>b?(b=c(Math.pow(y,b)),S=S.j(b).add(c(k))):(S=S.j(I),S=S.add(c(k)))}return S}var p=u(0),m=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-P(this).m();for(var T=0,y=1,I=0;I<this.g.length;I++){var S=this.i(I);T+=(0<=S?S:4294967296+S)*y,y*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(R(this))return"0";if(N(this))return"-"+P(this).toString(T);for(var y=c(Math.pow(T,6)),I=this,S="";;){var C=x(I,y).g;I=_(I,C.j(y));var b=((0<I.g.length?I.g[0]:I.h)>>>0).toString(T);if(I=C,R(I))return b+S;for(;6>b.length;)b="0"+b;S=b+S}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function R(T){if(T.h!=0)return!1;for(var y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function N(T){return T.h==-1}t.l=function(T){return T=_(this,T),N(T)?-1:R(T)?0:1};function P(T){for(var y=T.g.length,I=[],S=0;S<y;S++)I[S]=~T.g[S];return new o(I,~T.h).add(m)}t.abs=function(){return N(this)?P(this):this},t.add=function(T){for(var y=Math.max(this.g.length,T.g.length),I=[],S=0,C=0;C<=y;C++){var b=S+(this.i(C)&65535)+(T.i(C)&65535),k=(b>>>16)+(this.i(C)>>>16)+(T.i(C)>>>16);S=k>>>16,b&=65535,k&=65535,I[C]=k<<16|b}return new o(I,I[I.length-1]&-2147483648?-1:0)};function _(T,y){return T.add(P(y))}t.j=function(T){if(R(this)||R(T))return p;if(N(this))return N(T)?P(this).j(P(T)):P(P(this).j(T));if(N(T))return P(this.j(P(T)));if(0>this.l(A)&&0>T.l(A))return c(this.m()*T.m());for(var y=this.g.length+T.g.length,I=[],S=0;S<2*y;S++)I[S]=0;for(S=0;S<this.g.length;S++)for(var C=0;C<T.g.length;C++){var b=this.i(S)>>>16,k=this.i(S)&65535,Rt=T.i(C)>>>16,br=T.i(C)&65535;I[2*S+2*C]+=k*br,v(I,2*S+2*C),I[2*S+2*C+1]+=b*br,v(I,2*S+2*C+1),I[2*S+2*C+1]+=k*Rt,v(I,2*S+2*C+1),I[2*S+2*C+2]+=b*Rt,v(I,2*S+2*C+2)}for(S=0;S<y;S++)I[S]=I[2*S+1]<<16|I[2*S];for(S=y;S<2*y;S++)I[S]=0;return new o(I,0)};function v(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function w(T,y){this.g=T,this.h=y}function x(T,y){if(R(y))throw Error("division by zero");if(R(T))return new w(p,p);if(N(T))return y=x(P(T),y),new w(P(y.g),P(y.h));if(N(y))return y=x(T,P(y)),new w(P(y.g),y.h);if(30<T.g.length){if(N(T)||N(y))throw Error("slowDivide_ only works with positive integers.");for(var I=m,S=y;0>=S.l(T);)I=O(I),S=O(S);var C=L(I,1),b=L(S,1);for(S=L(S,2),I=L(I,2);!R(S);){var k=b.add(S);0>=k.l(T)&&(C=C.add(I),b=k),S=L(S,1),I=L(I,1)}return y=_(T,C.j(y)),new w(C,y)}for(C=p;0<=T.l(y);){for(I=Math.max(1,Math.floor(T.m()/y.m())),S=Math.ceil(Math.log(I)/Math.LN2),S=48>=S?1:Math.pow(2,S-48),b=c(I),k=b.j(y);N(k)||0<k.l(T);)I-=S,b=c(I),k=b.j(y);R(b)&&(b=m),C=C.add(b),T=_(T,k)}return new w(C,T)}t.A=function(T){return x(this,T).h},t.and=function(T){for(var y=Math.max(this.g.length,T.g.length),I=[],S=0;S<y;S++)I[S]=this.i(S)&T.i(S);return new o(I,this.h&T.h)},t.or=function(T){for(var y=Math.max(this.g.length,T.g.length),I=[],S=0;S<y;S++)I[S]=this.i(S)|T.i(S);return new o(I,this.h|T.h)},t.xor=function(T){for(var y=Math.max(this.g.length,T.g.length),I=[],S=0;S<y;S++)I[S]=this.i(S)^T.i(S);return new o(I,this.h^T.h)};function O(T){for(var y=T.g.length+1,I=[],S=0;S<y;S++)I[S]=T.i(S)<<1|T.i(S-1)>>>31;return new o(I,T.h)}function L(T,y){var I=y>>5;y%=32;for(var S=T.g.length-I,C=[],b=0;b<S;b++)C[b]=0<y?T.i(b+I)>>>y|T.i(b+I+1)<<32-y:T.i(b+I);return new o(C,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,sw=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,fr=o}).apply(typeof Zg<"u"?Zg:typeof self<"u"?self:typeof window<"u"?window:{});var za=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Ut.makeFromUrl(e,n)}catch{return new Ut(e,"")}if(r.path==="")return r;throw A2(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(x){x.path.charAt(x.path.length-1)==="/"&&(x.path_=x.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+i+o,"i"),u={bucket:1,path:3};function c(x){x.path_=decodeURIComponent(x.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",A=new RegExp(`^https?://${p}/${f}/b/${i}/o${m}`,"i"),R={bucket:1,path:3},N=n===ME?"(?:storage.googleapis.com|storage.cloud.google.com)":n,P="([^?#]*)",_=new RegExp(`^https?://${N}/${i}/${P}`,"i"),w=[{regex:l,indices:u,postModify:s},{regex:A,indices:R,postModify:c},{regex:_,indices:{bucket:1,path:2},postModify:c}];for(let x=0;x<w.length;x++){const O=w[x],L=O.regex.exec(e);if(L){const T=L[O.indices.bucket];let y=L[O.indices.path];y||(y=""),r=new Ut(T,y),O.postModify(r);break}}if(r==null)throw S2(e);return r}}class R2{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
